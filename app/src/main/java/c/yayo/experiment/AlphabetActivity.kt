...
import kotlinx.android.synthetic.main.app_bar_alphabet.*

class AlphabetActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.alphabet, menu)
        return true
    }
